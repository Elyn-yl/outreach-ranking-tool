...
EXCEL_FILE = BASE_DIR / "config_template_user_input.xlsx"
OUTPUT_CONFIG = BASE_DIR / "config.py"
...
def main():
    if not EXCEL_FILE.exists():
        raise FileNotFoundError(
            f"Missing {EXCEL_FILE.name}. Put it in the same folder as this script."
        )
    ...
    print(f"Saved: {OUTPUT_CONFIG.name}")
